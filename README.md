...
- 「表示」ボタンをクリックするとブラウザで PDF が開きます
- 「ダウンロード」ボタンをクリックするとユーザーのデフォルトダウンロードフォルダに PDF が保存されます
...
|                                                       |
|  +-------------------------+   +--------------------+ |
|  | invoice_20250506.pdf   |   | invoice_20250505.pdf| |
|  | 作成日時: 2025/05/06   |   | 作成日時: 2025/05/05| |
|  |                        |   |                     | |
|  | [表示] [ダウンロード]  |   | [表示] [ダウンロード]| |
|  +-------------------------+   +--------------------+ |
|                                                       |
|  +-------------------------+   +--------------------+ |
|  | invoice_20250504.pdf   |   | invoice_20250503.pdf| |
|  | 作成日時: 2025/05/04   |   | 作成日時: 2025/05/03| |
|  |                        |   |                     | |
|  | [表示] [ダウンロード]  |   | [表示] [ダウンロード]| |
|  +-------------------------+   +--------------------+ |
|                                                       |
